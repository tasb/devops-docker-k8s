# Training on DevOps with Docker and Kubernetes

On this repo you can find all contents, from labs to slides, that allow you to gradually have an hands-on experience on containers using Docker, Kubernetes and Continuous Integration (CI) using Github Actions.
